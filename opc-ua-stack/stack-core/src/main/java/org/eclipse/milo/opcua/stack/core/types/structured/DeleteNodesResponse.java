...
public class DeleteNodesResponse implements UaResponseMessage {
    ...
    public DeleteNodesResponse(ResponseHeader _responseHeader,
                               StatusCode[] _results,
    ...
    public static void encode(DeleteNodesResponse deleteNodesResponse, UaEncoder encoder) {
        encoder.encodeSerializable(
            "ResponseHeader",
            deleteNodesResponse._responseHeader != null ? deleteNodesResponse._responseHeader : new ResponseHeader()
        );
    ...
    static {
        DelegateRegistry
            .registerEncoder(DeleteNodesResponse::encode, DeleteNodesResponse.class, BinaryEncodingId, XmlEncodingId);
        DelegateRegistry
            .registerDecoder(DeleteNodesResponse::decode, DeleteNodesResponse.class, BinaryEncodingId, XmlEncodingId);
    }
