...
public class HistoryUpdateResult implements UaStructure {
    ...
    public HistoryUpdateResult(StatusCode _statusCode,
                               StatusCode[] _operationResults,
    ...
    public static HistoryUpdateResult decode(UaDecoder decoder) {
        ...
        StatusCode[] _operationResults = decoder
            .decodeArray("OperationResults", decoder::decodeStatusCode, StatusCode.class);
    ...
    static {
        DelegateRegistry
            .registerEncoder(HistoryUpdateResult::encode, HistoryUpdateResult.class, BinaryEncodingId, XmlEncodingId);
        DelegateRegistry
            .registerDecoder(HistoryUpdateResult::decode, HistoryUpdateResult.class, BinaryEncodingId, XmlEncodingId);
    }
