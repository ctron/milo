...
public class ContentFilterElementResult implements UaStructure {
    ...
    public ContentFilterElementResult(StatusCode _statusCode,
                                      StatusCode[] _operandStatusCodes,
                                      DiagnosticInfo[] _operandDiagnosticInfos) {
    ...
    public static void encode(ContentFilterElementResult contentFilterElementResult, UaEncoder encoder) {
        ...
        encoder.encodeArray(
            "OperandStatusCodes",
            contentFilterElementResult._operandStatusCodes,
            encoder::encodeStatusCode
        );
        encoder.encodeArray(
            "OperandDiagnosticInfos",
            contentFilterElementResult._operandDiagnosticInfos,
    ...
    public static ContentFilterElementResult decode(UaDecoder decoder) {
        ...
        StatusCode[] _operandStatusCodes = decoder
            .decodeArray("OperandStatusCodes", decoder::decodeStatusCode, StatusCode.class);
        DiagnosticInfo[] _operandDiagnosticInfos = decoder
            .decodeArray("OperandDiagnosticInfos", decoder::decodeDiagnosticInfo, DiagnosticInfo.class);
