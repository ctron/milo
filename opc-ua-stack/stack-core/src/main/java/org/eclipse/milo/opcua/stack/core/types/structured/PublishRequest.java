...
public class PublishRequest implements UaRequestMessage {
    ...
    public static void encode(PublishRequest publishRequest, UaEncoder encoder) {
        encoder.encodeSerializable(
            "RequestHeader",
            publishRequest._requestHeader != null ? publishRequest._requestHeader : new RequestHeader()
        );
        encoder.encodeArray(
            "SubscriptionAcknowledgements",
            publishRequest._subscriptionAcknowledgements,
            encoder::encodeSerializable
        );
    }
    ...
    public static PublishRequest decode(UaDecoder decoder) {
        ...
        SubscriptionAcknowledgement[] _subscriptionAcknowledgements = decoder.decodeArray(
            "SubscriptionAcknowledgements",
