...
public class UpdateEventDetails extends HistoryUpdateDetails {
    ...
    public UpdateEventDetails(NodeId _nodeId,
                              PerformUpdateType _performInsertReplace,
                              EventFilter _filter,
    ...
    public static void encode(UpdateEventDetails updateEventDetails, UaEncoder encoder) {
        ...
        encoder.encodeSerializable(
            "Filter",
            updateEventDetails._filter != null ? updateEventDetails._filter : new EventFilter()
        );
    ...
    public static UpdateEventDetails decode(UaDecoder decoder) {
        ...
        HistoryEventFieldList[] _eventData = decoder
            .decodeArray("EventData", decoder::decodeSerializable, HistoryEventFieldList.class);
    ...
    static {
        DelegateRegistry
            .registerEncoder(UpdateEventDetails::encode, UpdateEventDetails.class, BinaryEncodingId, XmlEncodingId);
        DelegateRegistry
            .registerDecoder(UpdateEventDetails::decode, UpdateEventDetails.class, BinaryEncodingId, XmlEncodingId);
    }
