...
public class ModifyMonitoredItemsResponse implements UaResponseMessage {
    ...
    public ModifyMonitoredItemsResponse(ResponseHeader _responseHeader,
    ...
    public static void encode(ModifyMonitoredItemsResponse modifyMonitoredItemsResponse, UaEncoder encoder) {
        encoder.encodeSerializable(
            "ResponseHeader",
            modifyMonitoredItemsResponse._responseHeader != null ?
                modifyMonitoredItemsResponse._responseHeader :
                new ResponseHeader()
        );
        encoder.encodeArray("Results", modifyMonitoredItemsResponse._results, encoder::encodeSerializable);
        encoder.encodeArray(
            "DiagnosticInfos",
            modifyMonitoredItemsResponse._diagnosticInfos,
    ...
    public static ModifyMonitoredItemsResponse decode(UaDecoder decoder) {
        ...
        MonitoredItemModifyResult[] _results = decoder
            .decodeArray("Results", decoder::decodeSerializable, MonitoredItemModifyResult.class);
