...
public class RegisterServer2Request implements UaRequestMessage {
    ...
    public RegisterServer2Request(RequestHeader _requestHeader,
                                  RegisteredServer _server,
                                  ExtensionObject[] _discoveryConfiguration) {
    ...
    public static void encode(RegisterServer2Request registerServer2Request, UaEncoder encoder) {
        encoder.encodeSerializable(
            "RequestHeader",
            registerServer2Request._requestHeader != null ? registerServer2Request._requestHeader : new RequestHeader()
        );
        encoder.encodeSerializable(
            "Server",
            registerServer2Request._server != null ? registerServer2Request._server : new RegisteredServer()
        );
        encoder.encodeArray(
            "DiscoveryConfiguration",
            registerServer2Request._discoveryConfiguration,
    ...
    public static RegisterServer2Request decode(UaDecoder decoder) {
        ...
        ExtensionObject[] _discoveryConfiguration = decoder
            .decodeArray("DiscoveryConfiguration", decoder::decodeExtensionObject, ExtensionObject.class);
