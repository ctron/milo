...
public class ContentFilterElement implements UaStructure {
    ...
    public static ContentFilterElement decode(UaDecoder decoder) {
        ...
        ExtensionObject[] _filterOperands = decoder
            .decodeArray("FilterOperands", decoder::decodeExtensionObject, ExtensionObject.class);
    ...
    static {
        DelegateRegistry
            .registerEncoder(ContentFilterElement::encode, ContentFilterElement.class, BinaryEncodingId, XmlEncodingId);
        DelegateRegistry
            .registerDecoder(ContentFilterElement::decode, ContentFilterElement.class, BinaryEncodingId, XmlEncodingId);
    }
