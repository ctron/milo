...
public class UaMethodLoader {
    ...
    private void buildNode0() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12543"),
            new QualifiedName(0, "OpenWithMasks"),
            new LocalizedText("en", "OpenWithMasks"),
            Optional.empty(),
    ...
    private void buildNode1() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12546"),
            new QualifiedName(0, "CloseAndUpdate"),
            new LocalizedText("en", "CloseAndUpdate"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode2() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12548"),
            new QualifiedName(0, "AddCertificate"),
            new LocalizedText("en", "AddCertificate"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode3() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12550"),
            new QualifiedName(0, "RemoveCertificate"),
            new LocalizedText("en", "RemoveCertificate"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode4() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12616"),
            new QualifiedName(0, "UpdateCertificate"),
            new LocalizedText("en", "UpdateCertificate"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode5() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12647"),
            new QualifiedName(0, "Open"),
            new LocalizedText("en", "Open"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode6() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12650"),
            new QualifiedName(0, "Close"),
            new LocalizedText("en", "Close"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode7() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12652"),
            new QualifiedName(0, "Read"),
            new LocalizedText("en", "Read"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode8() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12655"),
            new QualifiedName(0, "Write"),
            new LocalizedText("en", "Write"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode9() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12657"),
            new QualifiedName(0, "GetPosition"),
            new LocalizedText("en", "GetPosition"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode10() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12660"),
            new QualifiedName(0, "SetPosition"),
            new LocalizedText("en", "SetPosition"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode15() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12731"),
            new QualifiedName(0, "CreateSigningRequest"),
            new LocalizedText("en", "CreateSigningRequest"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode16() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12734"),
            new QualifiedName(0, "ApplyChanges"),
            new LocalizedText("en", "ApplyChanges"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode19() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12746"),
            new QualifiedName(0, "SetSubscriptionDurable"),
            new LocalizedText("en", "SetSubscriptionDurable"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode21() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12775"),
            new QualifiedName(0, "GetRejectedList"),
            new LocalizedText("en", "GetRejectedList"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode23() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12871"),
            new QualifiedName(0, "ResendData"),
            new LocalizedText("en", "ResendData"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode25() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12883"),
            new QualifiedName(0, "RequestServerStateChange"),
            new LocalizedText("en", "RequestServerStateChange"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode27() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=12912"),
            new QualifiedName(0, "ConditionRefresh2"),
            new LocalizedText("en", "ConditionRefresh2"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode28() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=9027"),
            new QualifiedName(0, "Enable"),
            new LocalizedText("en", "Enable"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode29() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=9028"),
            new QualifiedName(0, "Disable"),
            new LocalizedText("en", "Disable"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode30() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=9029"),
            new QualifiedName(0, "AddComment"),
            new LocalizedText("en", "AddComment"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode31() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=9069"),
            new QualifiedName(0, "Respond"),
            new LocalizedText("en", "Respond"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode32() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=9111"),
            new QualifiedName(0, "Acknowledge"),
            new LocalizedText("en", "Acknowledge"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode33() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=9113"),
            new QualifiedName(0, "Confirm"),
            new LocalizedText("en", "Confirm"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode34() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=9211"),
            new QualifiedName(0, "Unshelve"),
            new LocalizedText("en", "Unshelve"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode35() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=9212"),
            new QualifiedName(0, "OneShotShelve"),
            new LocalizedText("en", "OneShotShelve"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode36() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=9213"),
            new QualifiedName(0, "TimedShelve"),
            new LocalizedText("en", "TimedShelve"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode37() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=13355"),
            new QualifiedName(0, "CreateDirectory"),
            new LocalizedText("en", "CreateDirectory"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode38() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=13358"),
            new QualifiedName(0, "CreateFile"),
            new LocalizedText("en", "CreateFile"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode39() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=13361"),
            new QualifiedName(0, "Delete"),
            new LocalizedText("en", "Delete"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode40() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=13363"),
            new QualifiedName(0, "MoveOrCopy"),
            new LocalizedText("en", "MoveOrCopy"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode114() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=2426"),
            new QualifiedName(0, "Start"),
            new LocalizedText("en", "Start"),
            Optional.of(
                new LocalizedText("en", "Causes the Program to transition from the Ready state to the Running state.")
            ),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode115() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=2427"),
            new QualifiedName(0, "Suspend"),
            new LocalizedText("en", "Suspend"),
            Optional.of(
                new LocalizedText(
                    "en",
    ...
    private void buildNode116() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=2428"),
            new QualifiedName(0, "Resume"),
            new LocalizedText("en", "Resume"),
            Optional.of(
                new LocalizedText(
                    "en",
    ...
    private void buildNode117() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=2429"),
            new QualifiedName(0, "Halt"),
            new LocalizedText("en", "Halt"),
            Optional.of(
                new LocalizedText(
                    "en",
    ...
    private void buildNode118() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=2430"),
            new QualifiedName(0, "Reset"),
            new LocalizedText("en", "Reset"),
            Optional.of(
                new LocalizedText("en", "Causes the Program to transition from the Halted state to the Ready state.")
            ),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode122() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=11489"),
            new QualifiedName(0, "GetMonitoredItems"),
            new LocalizedText("en", "GetMonitoredItems"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
    ...
    private void buildNode130() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=11615"),
            new QualifiedName(0, "ExportNamespace"),
            new LocalizedText("en", "ExportNamespace"),
            Optional.of(new LocalizedText("en", "Updates the file by exporting the server namespace.")),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
            true
    ...
    private void buildNode143() {
        UaMethodNode node = new UaMethodNode(
            this.nodeManager,
            NodeId.parse("ns=0;i=3875"),
            new QualifiedName(0, "ConditionRefresh"),
            new LocalizedText("en", "ConditionRefresh"),
            Optional.empty(),
            Optional.of(UInteger.valueOf(0L)),
            Optional.of(UInteger.valueOf(0L)),
            true,
