...
public class AddNodesResponse implements UaResponseMessage {
    ...
    public AddNodesResponse(ResponseHeader _responseHeader,
    ...
    public static void encode(AddNodesResponse addNodesResponse, UaEncoder encoder) {
        encoder.encodeSerializable(
            "ResponseHeader",
            addNodesResponse._responseHeader != null ? addNodesResponse._responseHeader : new ResponseHeader()
        );
    ...
    static {
        DelegateRegistry
            .registerEncoder(AddNodesResponse::encode, AddNodesResponse.class, BinaryEncodingId, XmlEncodingId);
        DelegateRegistry
            .registerDecoder(AddNodesResponse::decode, AddNodesResponse.class, BinaryEncodingId, XmlEncodingId);
    }
