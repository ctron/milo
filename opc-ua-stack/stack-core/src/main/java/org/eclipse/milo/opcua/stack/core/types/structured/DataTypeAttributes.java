...
public class DataTypeAttributes extends NodeAttributes {
    ...
    public DataTypeAttributes(UInteger _specifiedAttributes,
    ...
    static {
        DelegateRegistry
            .registerEncoder(DataTypeAttributes::encode, DataTypeAttributes.class, BinaryEncodingId, XmlEncodingId);
        DelegateRegistry
            .registerDecoder(DataTypeAttributes::decode, DataTypeAttributes.class, BinaryEncodingId, XmlEncodingId);
    }
