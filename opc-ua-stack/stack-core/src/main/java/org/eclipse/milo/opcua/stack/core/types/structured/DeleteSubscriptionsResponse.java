...
public class DeleteSubscriptionsResponse implements UaResponseMessage {
    ...
    public DeleteSubscriptionsResponse(ResponseHeader _responseHeader,
                                       StatusCode[] _results,
    ...
    public static void encode(DeleteSubscriptionsResponse deleteSubscriptionsResponse, UaEncoder encoder) {
        encoder.encodeSerializable(
            "ResponseHeader",
            deleteSubscriptionsResponse._responseHeader != null ?
                deleteSubscriptionsResponse._responseHeader :
                new ResponseHeader()
        );
        encoder.encodeArray("Results", deleteSubscriptionsResponse._results, encoder::encodeStatusCode);
        encoder.encodeArray(
            "DiagnosticInfos",
            deleteSubscriptionsResponse._diagnosticInfos,
