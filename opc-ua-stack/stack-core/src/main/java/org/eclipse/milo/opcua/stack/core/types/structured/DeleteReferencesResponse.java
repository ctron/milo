...
public class DeleteReferencesResponse implements UaResponseMessage {
    ...
    public DeleteReferencesResponse(ResponseHeader _responseHeader,
                                    StatusCode[] _results,
    ...
    public static void encode(DeleteReferencesResponse deleteReferencesResponse, UaEncoder encoder) {
        encoder.encodeSerializable(
            "ResponseHeader",
            deleteReferencesResponse._responseHeader != null ?
                deleteReferencesResponse._responseHeader :
                new ResponseHeader()
        );
        encoder.encodeArray("Results", deleteReferencesResponse._results, encoder::encodeStatusCode);
        encoder
            .encodeArray("DiagnosticInfos", deleteReferencesResponse._diagnosticInfos, encoder::encodeDiagnosticInfo);
    }
