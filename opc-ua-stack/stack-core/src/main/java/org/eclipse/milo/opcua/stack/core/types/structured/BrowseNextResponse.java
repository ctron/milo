...
public class BrowseNextResponse implements UaResponseMessage {
    ...
    public BrowseNextResponse(ResponseHeader _responseHeader,
    ...
    public static void encode(BrowseNextResponse browseNextResponse, UaEncoder encoder) {
        encoder.encodeSerializable(
            "ResponseHeader",
            browseNextResponse._responseHeader != null ? browseNextResponse._responseHeader : new ResponseHeader()
        );
    ...
    static {
        DelegateRegistry
            .registerEncoder(BrowseNextResponse::encode, BrowseNextResponse.class, BinaryEncodingId, XmlEncodingId);
        DelegateRegistry
            .registerDecoder(BrowseNextResponse::decode, BrowseNextResponse.class, BinaryEncodingId, XmlEncodingId);
    }
