...
public class VariableTypeNode extends TypeNode {
    ...
    public VariableTypeNode(NodeId _nodeId,
    ...
    static {
        DelegateRegistry
            .registerEncoder(VariableTypeNode::encode, VariableTypeNode.class, BinaryEncodingId, XmlEncodingId);
        DelegateRegistry
            .registerDecoder(VariableTypeNode::decode, VariableTypeNode.class, BinaryEncodingId, XmlEncodingId);
    }
