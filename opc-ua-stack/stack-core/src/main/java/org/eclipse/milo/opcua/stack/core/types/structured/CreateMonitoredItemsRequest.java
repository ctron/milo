...
public class CreateMonitoredItemsRequest implements UaRequestMessage {
    ...
    public CreateMonitoredItemsRequest(RequestHeader _requestHeader,
    ...
    public static void encode(CreateMonitoredItemsRequest createMonitoredItemsRequest, UaEncoder encoder) {
        encoder.encodeSerializable(
            "RequestHeader",
            createMonitoredItemsRequest._requestHeader != null ?
                createMonitoredItemsRequest._requestHeader :
                new RequestHeader()
        );
    ...
    public static CreateMonitoredItemsRequest decode(UaDecoder decoder) {
        ...
        MonitoredItemCreateRequest[] _itemsToCreate = decoder
            .decodeArray("ItemsToCreate", decoder::decodeSerializable, MonitoredItemCreateRequest.class);
