...
public class SetMonitoringModeResponse implements UaResponseMessage {
    ...
    public SetMonitoringModeResponse(ResponseHeader _responseHeader,
                                     StatusCode[] _results,
    ...
    public static void encode(SetMonitoringModeResponse setMonitoringModeResponse, UaEncoder encoder) {
        encoder.encodeSerializable(
            "ResponseHeader",
            setMonitoringModeResponse._responseHeader != null ?
                setMonitoringModeResponse._responseHeader :
                new ResponseHeader()
        );
        encoder.encodeArray("Results", setMonitoringModeResponse._results, encoder::encodeStatusCode);
        encoder
            .encodeArray("DiagnosticInfos", setMonitoringModeResponse._diagnosticInfos, encoder::encodeDiagnosticInfo);
    }
