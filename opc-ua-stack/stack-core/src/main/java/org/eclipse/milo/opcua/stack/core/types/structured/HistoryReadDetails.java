...
public class HistoryReadDetails implements UaStructure {
    ...
    static {
        DelegateRegistry
            .registerEncoder(HistoryReadDetails::encode, HistoryReadDetails.class, BinaryEncodingId, XmlEncodingId);
        DelegateRegistry
            .registerDecoder(HistoryReadDetails::decode, HistoryReadDetails.class, BinaryEncodingId, XmlEncodingId);
    }
