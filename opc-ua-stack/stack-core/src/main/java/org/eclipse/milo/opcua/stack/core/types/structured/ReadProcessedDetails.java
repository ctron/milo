...
public class ReadProcessedDetails extends HistoryReadDetails {
    ...
    public ReadProcessedDetails(DateTime _startTime,
                                DateTime _endTime,
    ...
    public static void encode(ReadProcessedDetails readProcessedDetails, UaEncoder encoder) {
        ...
        encoder.encodeSerializable(
            ...
            readProcessedDetails._aggregateConfiguration != null ?
                readProcessedDetails._aggregateConfiguration :
    ...
    static {
        DelegateRegistry
            .registerEncoder(ReadProcessedDetails::encode, ReadProcessedDetails.class, BinaryEncodingId, XmlEncodingId);
        DelegateRegistry
            .registerDecoder(ReadProcessedDetails::decode, ReadProcessedDetails.class, BinaryEncodingId, XmlEncodingId);
    }
