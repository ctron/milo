...
public class FindServersOnNetworkRequest implements UaRequestMessage {
    ...
    public FindServersOnNetworkRequest(RequestHeader _requestHeader,
                                       UInteger _startingRecordId,
                                       UInteger _maxRecordsToReturn,
                                       String[] _serverCapabilityFilter) {
    ...
    public static void encode(FindServersOnNetworkRequest findServersOnNetworkRequest, UaEncoder encoder) {
        encoder.encodeSerializable(
            "RequestHeader",
            findServersOnNetworkRequest._requestHeader != null ?
                findServersOnNetworkRequest._requestHeader :
                new RequestHeader()
        );
        ...
        encoder.encodeArray(
            ...
            findServersOnNetworkRequest._serverCapabilityFilter,
    ...
    public static FindServersOnNetworkRequest decode(UaDecoder decoder) {
        ...
        String[] _serverCapabilityFilter = decoder
            .decodeArray("ServerCapabilityFilter", decoder::decodeString, String.class);

        return new FindServersOnNetworkRequest(
            _requestHeader,
            _startingRecordId,
            _maxRecordsToReturn,
            _serverCapabilityFilter
        );
    }
